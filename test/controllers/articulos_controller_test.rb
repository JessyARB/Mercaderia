...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { description: @articulo.description, name: @articulo.name, picture: @articulo.picture } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { description: @articulo.description, name: @articulo.name, picture: @articulo.picture } }
